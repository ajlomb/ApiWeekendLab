...
public class MainActivity extends AppCompatActivity implements ApiHelper.ApiResponseHandler {
    ...
    public void doSearch(View view) {
        ...
        ApiHelper.getInstance(MainActivity.this).doRequest(varSearch);
...
//                });
    ...
    public void handleResponse(String address){
        ImageView imageView = (ImageView)findViewById(R.id.image_view_main);
        Picasso.with(MainActivity.this).load(address).into(imageView);
    }
}
